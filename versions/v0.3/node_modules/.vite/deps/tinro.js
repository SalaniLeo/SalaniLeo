...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("redirect" in $$props2)
      $$invalidate(5, redirect = $$props2.redirect);
    if ("firstmatch" in $$props2)
      $$invalidate(6, firstmatch = $$props2.firstmatch);
    if ("breadcrumb" in $$props2)
      $$invalidate(7, breadcrumb = $$props2.breadcrumb);
    if ("$$scope" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("breadcrumb" in $$props2)
      $$invalidate(7, breadcrumb = $$props2.breadcrumb);
    if ("showContent" in $$props2)
      $$invalidate(0, showContent = $$props2.showContent);
    if ("params" in $$props2)
